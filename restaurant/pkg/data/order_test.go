...
func TestReadAll(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"id", "Date", "Table", "Waiter", "Price", "Payment"}).
		AddRow(testFullOrder.Id, testFullOrder.Date, testFullOrder.Table, testFullOrder.Waiter, testFullOrder.Price, testFullOrder.Payment)
